      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .title .logo {
          ...
          background: radial-gradient(circle at 30% 30%, #f472b6, transparent 45%),
                      radial-gradient(circle at 80% 20%, #22d3ee, transparent 42%),
                      linear-gradient(145deg, #6366f1, #22c55e);
          color: #0b1224; font-weight: 900; font-size: 18px;
        ...
        @media (max-width: 540px) {
          ...
          .title { font-size: 18px; gap: 12px; }
          .title .logo { width: 46px; height: 46px; font-size: 18px; border-radius: 16px; }
          .message { font-size: 13px; margin-top: 6px; margin-bottom: 18px; }
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 540px) {
          ...
          .badge { width: 34px; height: 34px; font-size: 16px; }
